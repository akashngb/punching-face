...
const children = [spawn('.local/newton-env/bin/python', ['physics_server.py'], {stdio:'inherit'}), spawn('.venv/bin/python', ['server.py'], {stdio:'inherit'}), spawn('node', ['node_modules/vite/bin/vite.js'], {stdio:'inherit'})];
let stopping=false;
