...
scene.fog = new THREE.Fog('#f6f7f2', 3, 9);
...
function panel(x, y, z, sx, sy, sz) {
  const o = new THREE.Mesh(
    new THREE.BoxGeometry(sx, sy, sz),
    new THREE.MeshStandardMaterial({ color: 0xfafbf6, roughness: 1 }),
  );
...
panel(0, -1.28, -1, 8, 0.02, 8);
panel(0, 0.6, -3.3, 8, 4, 0.02);
panel(-2.3, 0.6, -0.6, 0.02, 4, 6);
panel(2.3, 0.6, -0.6, 0.02, 4, 6);

function wallGrid(size, divisions, rotX, rotZ, px, py, pz) {
  const g = new THREE.GridHelper(size, divisions, 0x4a5548, 0x8b948a);
...
wallGrid(8, 32, Math.PI / 2, 0, 0, 0.6, -3.28);
wallGrid(6, 24, 0, Math.PI / 2, -2.28, 0.6, -0.6);
wallGrid(6, 24, 0, Math.PI / 2, 2.28, 0.6, -0.6);
